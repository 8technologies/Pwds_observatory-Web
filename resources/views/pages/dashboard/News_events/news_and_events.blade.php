...
<div class="card card-flush">
    ...
    <div class="card-header mt-6">
        ...
        <div class="card-toolbar">
            <!--begin::Button-->
            <a class="btn btn-light-primary" href="{{ route('post_news') }}">
            ...
            <!--end::Svg Icon-->Post Event or Article</a>
            <!--end::Button-->
        </div>
        <!--end::Card toolbar-->
    </div>
                    ...
                    <td class="text-end">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                            ...
                            <div class="menu-item px-3">
                                <a href="{{ route("admin_news", ["id" => $event->id]) }}" class="menu-link px-3">Edit</a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
                                <a class="menu-link px-3" onclick='deleteItem("{{ route("admin_news", ["id" => $event->id]) }}?action=delete")'>Delete</a>
                            </div>
                            <!--end::Menu item-->
                        </div>
                        <!--end::Menu-->
