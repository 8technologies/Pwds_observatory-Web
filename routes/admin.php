...
Route::middleware(['profile.incomplete'])->group(function () {
    ...
    Route::match(['GET', 'POST'], '/news_and_events/{id?}', [NewsEventsController::class, 'view'])->name('admin_news');
    ...
    Route::match(['GET', 'POST'], '/account_settings', [AuthController::class, 'account'])->name('account');
});
